...
[ -z "$dotfilesrepo" ] && dotfilesrepo="https://github.com/isostacy/dotfiles.git"
[ -z "$progsfile" ] && progsfile="https://raw.githubusercontent.com/Isostacy/larbs/master/progs.csv"
...
# copy wallpaper to wallpaper
sudo cp /home/$name/.wallpapers/nord.png /usr/share/wallpapers
